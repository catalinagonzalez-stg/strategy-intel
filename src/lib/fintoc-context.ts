...
export const FINTOC_CONTEXT = {
    ...
    products: {
          ...
          marte: {
                  name: 'Marte',
                  description: 'Agente de IA para empresas — se conecta a CRM (HubSpot), calendario (Google Calendar), email (Gmail), Slack y bases de datos. Automatiza follow-ups post-reunion, creacion de deals, agendamiento y busqueda de informacion de clientes. Disponible en marte.fintoc.com.',
                  category: 'ai_agents',
                  competitors: ['Salesforce Einstein', 'HubSpot AI', 'Clay', 'Apollo AI', 'Regie.ai'],
          },
    },
    ...
    competitors: {
          ...
          categories: {
                  ...
                  ai_agents: ['Salesforce Einstein', 'HubSpot AI', 'Clay', 'Apollo AI'],
          },
    },
    ...
    strategic_priorities: [
          ...
          'Marte (agente IA) — venta a clientes externos, expansion de casos de uso (follow-ups, deals, agendamiento, contracargos)',
    ...
    topics_by_relevance: {
          ...
          high: ['acquiring', 'payouts', 'instant_payments', 'fraude', 'competition', 'ai_agents', 'ai_automation'],
    ...
    newsletter: {
          ...
          audience: 'Todo el equipo de Fintoc (~50 personas)',
          tone: 'Informativo, interesante, conciso. En espanol. Nunca alarmista ni prescriptivo.',
          sections: [
          ...
          validation_rules: {
                  ...
                  require_fintoc_implication: false,
